    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(stringResource(R.string.jan), style = MaterialTheme.typography.labelSmall)
                Text(stringResource(R.string.jun), style = MaterialTheme.typography.labelSmall)
                Text(stringResource(R.string.dec), style = MaterialTheme.typography.labelSmall)
            }
        }
    }
}
